...
start_questionnaire = driver.find_element(By.XPATH, "/html/body/div[1]/div[2]/div/div/div[2]/button/span[1]")
hover = ActionChains(driver).move_to_element(start_questionnaire)
hover.perform()
start_questionnaire.click()

question_1 = driver.find_element(By.XPATH, "/html/body/div[1]/div/div/div/div[2]/main/div/div/div/div/form/div[6]/div/div/div/div/div/div/div/div/fieldset/label[2]/span")
driver.execute_script("arguments[0].scrollIntoView(true);", question_1)
hover = ActionChains(driver).move_to_element(question_1)
hover.perform()
question_1.click()

question_2 = driver.find_element(By.XPATH, "/html/body/div[1]/div/div/div/div[2]/main/div/div/div/div/form/div[8]/div/div/div/div/div/div/div/div/fieldset/label[1]/span")
driver.execute_script("arguments[0].scrollIntoView(true);", question_2)
hover = ActionChains(driver).move_to_element(question_2)
hover.perform()
question_2.click()

question_3 = driver.find_element(By.XPATH, "/html/body/div[1]/div/div/div/div[2]/main/div/div/div/div/form/div[10]/div/div/div/div/div/div/div/div/fieldset/label[1]/span")
driver.execute_script("arguments[0].scrollIntoView(true);", question_3)
hover = ActionChains(driver).move_to_element(question_3)
hover.perform()
question_3.click()

question_4 = driver.find_element(By.XPATH, "/html/body/div[1]/div/div/div/div[2]/main/div/div/div/div/form/div[12]/div/div/div/div/div/div/div/div/fieldset/label[1]/span")
driver.execute_script("arguments[0].scrollIntoView(true);", question_4)
hover = ActionChains(driver).move_to_element(question_4)
hover.perform()
question_4.click()

question_5 = driver.find_element(By.XPATH, "/html/body/div[1]/div/div/div/div[2]/main/div/div/div/div/form/div[14]/div/div/div/div/div/div/div/div/fieldset/label[1]/span")
driver.execute_script("arguments[0].scrollIntoView(true);", question_5)
hover = ActionChains(driver).move_to_element(question_5)
hover.perform()
question_5.click()

question_6 = driver.find_element(By.XPATH, "/html/body/div[1]/div/div/div/div[2]/main/div/div/div/div/form/div[16]/div/div/div/div/div/div/div/div/fieldset/label[1]/span")
...
final_submit = driver.find_element(By.XPATH, "/html/body/div[1]/div/div/div/div[2]/main/div/div/div/div/div/button/span[1]")
